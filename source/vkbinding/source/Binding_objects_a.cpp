...
Function<VkResult, VkDevice, VkSwapchainKHR> Binding::AcquireFullScreenExclusiveModeEXT("vkAcquireFullScreenExclusiveModeEXT");
Function<VkResult, VkDevice, VkImage, int, VkSemaphore, VkFence> Binding::AcquireImageANDROID("vkAcquireImageANDROID");
...
Function<VkResult, VkPhysicalDevice, Display*, VkDisplayKHR> Binding::AcquireXlibDisplayEXT("vkAcquireXlibDisplayEXT");
