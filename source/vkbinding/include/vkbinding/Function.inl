...
{
    inline static ReturnType call(const vkbinding::Function<ReturnType, Arguments...> * function, Arguments&&... arguments)
    {
        return reinterpret_cast<typename vkbinding::Function<ReturnType, Arguments...>::Signature>(function->address())(std::forward<Arguments>(arguments)...);
    }
};
...
struct FunctionHelper
{
    inline static ReturnType call(const vkbinding::Function<ReturnType, Arguments...> * function, Arguments&&... arguments)
    {
        vkbinding::FunctionCall functionCall(function);

        if (function->isAnyEnabled(vkbinding::CallbackMask::Parameters))
        {
            functionCall.parameters = vkbinding::createValues(std::forward<Arguments>(arguments)...);
        }

        if (function->isEnabled(vkbinding::CallbackMask::Before))
        {
        ...
        if (function->isAnyEnabled(vkbinding::CallbackMask::ReturnValue))
        {
            functionCall.returnValue = vkbinding::createValue(value);
        }

        if (function->isEnabled(vkbinding::CallbackMask::After))
        {
        ...
        if (function->isEnabled(vkbinding::CallbackMask::Logging))
        {
...
{
    inline static void call(const vkbinding::Function<void, Arguments...> * function, Arguments&&... arguments)
    {
        vkbinding::FunctionCall functionCall(function);
