...
*/
template <typename T>
class VKBINDING_TEMPLATE_API Value : public AbstractValue
{
public:
    /**
    *  @brief
    ...
    */
    VKBINDING_CONSTEXPR inline Value(const T & value);
    ...
    *    The value
    */
    VKBINDING_CONSTEXPR inline T value() const;
