...
*/
VKBINDING_CONSTEXPR inline CallbackMask operator~(CallbackMask a);
...
*/
VKBINDING_CONSTEXPR inline CallbackMask operator|(CallbackMask a, CallbackMask b);
...
#include <vkbinding/CallbackMask.inl>