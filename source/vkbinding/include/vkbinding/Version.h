...
*  @endcode
*/
class VKBINDING_TEMPLATE_API Version
{
public:
    /**
    *  @brief
    ...
    */
    VKBINDING_CONSTEXPR inline Version();
    ...
    *    The minor version
    */
    VKBINDING_CONSTEXPR inline Version(unsigned char majorVersion, unsigned char minorVersion);
    ...
    */
    VKBINDING_CONSTEXPR inline Version(const Version & version);
    ...
    *    The major version
    */
    VKBINDING_CONSTEXPR inline unsigned char majorVersion() const;
    ...
    *    The minor version
    */
    VKBINDING_CONSTEXPR inline unsigned char minorVersion() const;
    ...
    */
    VKBINDING_CONSTEXPR inline bool isNull() const;
    ...
    */
    VKBINDING_CONSTEXPR inline bool operator<(const Version & version) const;
