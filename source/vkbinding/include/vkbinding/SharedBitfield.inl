...
template <typename T>
VKBINDING_CONSTEXPR SharedBitfieldBase<T>::SharedBitfieldBase(T value)
: m_value{value}
{
}

template <typename T>
VKBINDING_CONSTEXPR SharedBitfieldBase<T>::operator T() const
{
    return m_value;
}
...
VKBINDING_CONSTEXPR SharedBitfield<Type>::SharedBitfield(ConstructionType value)
...
template <typename Type>
VKBINDING_CONSTEXPR SharedBitfield<Type>::SharedBitfield(typename std::underlying_type<Type>::type value)
: SharedBitfieldBase<typename std::underlying_type<Type>::type>(value)
{
}

template <typename Type>
VKBINDING_CONSTEXPR SharedBitfield<Type>::operator Type() const
{
...
template <typename Type>
template <typename... T>
VKBINDING_CONSTEXPR auto SharedBitfield<Type>::operator|(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type>::type
{
...
template <typename Type>
template <typename... T>
VKBINDING_CONSTEXPR auto SharedBitfield<Type>::operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type
{
...
template <typename Type>
template <typename T>
VKBINDING_CONSTEXPR auto SharedBitfield<Type>::operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type>::value, bool>::type
{
    return static_cast<UnderlyingType>(*this) == static_cast<UnderlyingType>(other);
}
...
template <typename ConstructionType>
VKBINDING_CONSTEXPR SharedBitfield<Type, Types...>::SharedBitfield(ConstructionType value)
...
template <typename Type, typename... Types>
VKBINDING_CONSTEXPR SharedBitfield<Type, Types...>::SharedBitfield(typename std::underlying_type<Type>::type value)
: SharedBitfield<Types...>(value)
{
}

template <typename Type, typename... Types>
VKBINDING_CONSTEXPR SharedBitfield<Type, Types...>::operator Type() const
{
    return static_cast<Type>(this->m_value);
}
...
template <typename Type, typename... Types>
template <typename... T>
VKBINDING_CONSTEXPR auto SharedBitfield<Type, Types...>::operator==(SharedBitfield<T...> other) const -> typename std::enable_if<!std::is_same<typename intersect_SharedBitfield<SharedBitfield<Type, Types...>, SharedBitfield<T...>>::type, SharedBitfield<>>::value, bool>::type
{
    return static_cast<UnderlyingType>(*this) == static_cast<UnderlyingType>(other);
}
...
template <typename Type, typename... Types>
template <typename T>
VKBINDING_CONSTEXPR auto SharedBitfield<Type, Types...>::operator==(T other) const -> typename std::enable_if<is_member_of_SharedBitfield<T, Type, Types...>::value, bool>::type
{
    return static_cast<UnderlyingType>(*this) == static_cast<UnderlyingType>(other);
}
...
VKBINDING_CONSTEXPR typename std::enable_if<std::is_base_of<SharedBitfieldBase<typename std::underlying_type<typename std::enable_if<std::is_enum<Enum>::value, Enum>::type>::type>, ConvertibleEnum>::value, Enum>::type
