...
*/
template <typename ReturnType, typename... Arguments>
struct VKBINDING_TEMPLATE_API CallbackType
{
...
struct VKBINDING_TEMPLATE_API CallbackType<void, Arguments...>
{
...
*/
template <typename ReturnType, typename... Arguments>
class VKBINDING_TEMPLATE_API Function : public AbstractFunction
{
public:
...
#include <vkbinding/Function.inl>