...
const std::unordered_map<VKextension, std::set<std::string>> Meta_FunctionStringsByExtension =
{
    ...
    { VKextension::VK_ANDROID_external_memory_android_hardware_buffer, { "vkGetAndroidHardwareBufferPropertiesANDROID", "vkGetMemoryAndroidHardwareBufferANDROID" } },
    { VKextension::VK_ANDROID_native_buffer, { "vkAcquireImageANDROID", "vkGetSwapchainGrallocUsage2ANDROID", "vkGetSwapchainGrallocUsageANDROID", "vkQueueSignalReleaseImageANDROID" } },
    { VKextension::VK_EXT_acquire_xlib_display, { "vkAcquireXlibDisplayEXT", "vkGetRandROutputDisplayEXT" } },
    ...
    { VKextension::VK_EXT_full_screen_exclusive, { "vkAcquireFullScreenExclusiveModeEXT", "vkGetDeviceGroupSurfacePresentModes2EXT", "vkGetDeviceGroupSurfacePresentModes2EXT", "vkGetPhysicalDeviceSurfacePresentModes2EXT", "vkReleaseFullScreenExclusiveModeEXT" } },
    ...
    { VKextension::VK_EXT_metal_surface, { "vkCreateMetalSurfaceEXT" } },
    ...
    { VKextension::VK_FUCHSIA_imagepipe_surface, { "vkCreateImagePipeSurfaceFUCHSIA" } },
    { VKextension::VK_GGP_stream_descriptor_surface, { "vkCreateStreamDescriptorSurfaceGGP" } },
    ...
    { VKextension::VK_KHR_android_surface, { "vkCreateAndroidSurfaceKHR" } },
    ...
    { VKextension::VK_KHR_external_fence_win32, { "vkGetFenceWin32HandleKHR", "vkImportFenceWin32HandleKHR" } },
    ...
    { VKextension::VK_KHR_external_memory_win32, { "vkGetMemoryWin32HandleKHR", "vkGetMemoryWin32HandlePropertiesKHR" } },
    ...
    { VKextension::VK_KHR_external_semaphore_win32, { "vkGetSemaphoreWin32HandleKHR", "vkImportSemaphoreWin32HandleKHR" } },
    ...
    { VKextension::VK_KHR_wayland_surface, { "vkCreateWaylandSurfaceKHR", "vkGetPhysicalDeviceWaylandPresentationSupportKHR" } },
    { VKextension::VK_KHR_win32_surface, { "vkCreateWin32SurfaceKHR", "vkGetPhysicalDeviceWin32PresentationSupportKHR" } },
    { VKextension::VK_KHR_xcb_surface, { "vkCreateXcbSurfaceKHR", "vkGetPhysicalDeviceXcbPresentationSupportKHR" } },
    { VKextension::VK_KHR_xlib_surface, { "vkCreateXlibSurfaceKHR", "vkGetPhysicalDeviceXlibPresentationSupportKHR" } },
    { VKextension::VK_MVK_ios_surface, { "vkCreateIOSSurfaceMVK" } },
    { VKextension::VK_MVK_macos_surface, { "vkCreateMacOSSurfaceMVK" } },
    { VKextension::VK_NN_vi_surface, { "vkCreateViSurfaceNN" } },
    ...
    { VKextension::VK_NV_external_memory_win32, { "vkGetMemoryWin32HandleNV" } },
